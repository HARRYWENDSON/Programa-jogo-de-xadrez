...
public class ChessMatch {
	...
	public ChessPiece replacePromotedPiece(String type) {
		if (promoted == null) {
			throw new IllegalStateException("Não ah peça para ser Promovida");
		}
	...
	private ChessPiece King(Color color) {
		...
		throw new IllegalStateException("Rei na cor " + color + " Não existe no tabuleiro");
	}
